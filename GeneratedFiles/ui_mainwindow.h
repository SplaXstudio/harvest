...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "harvest", 0));
        actionConsole->setText(QApplication::translate("MainWindow", "console", 0));
        menu->setTitle(QApplication::translate("MainWindow", "\350\260\203\350\257\225", 0));
    } // retranslateUi
